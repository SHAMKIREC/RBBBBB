  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button className="bg-[#007bff] hover:bg-blue-600 text-white px-8 py-6 text-lg">
          Узнать условия
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[600px] bg-white rounded-[20px] border-2 border-gradient-to-r from-[#FF7A00] to-[#FF0000] dialog-content">
        <DialogClose className="absolute right-4 top-4 rounded-[20px] opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
          <X className="h-4 w-4" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="relative">
                  <div className="absolute -top-4 left-0 right-0 h-[2px] bg-gradient-to-r from-[#FF7A00] to-[#FF0000]"></div>
                  <Label className="text-[#333] font-medium">Куда отправить запрос?</Label>
                </div>
                <RadioGroup
                  value={sendMethod}
                  onValueChange={setSendMethod}
                  className="space-y-2 border-t-0"
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="system" id="system" className="form-radio" />
                  ...
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="telegram" id="telegram" className="form-radio" />
                  ...
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="whatsapp" id="whatsapp" className="form-radio" />
